<%@ Page Title="Programmer::" Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Programmer1.aspx.cs" Inherits="Contact" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">  
    ...
    <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#999999" OnRowDataBound="GridView1_DataBound" BorderStyle="None" BorderWidth="1px" CellPadding="3">
